                                    ...
                                    <div class="row">
                                            <div class="col-lg-12">
											  ...
											  <?php if($CI->session->flashdata('msg')){  
                                                ...
                                                <form action="<?= site_url('admin/Cms/EditCmsItem_ask');?>" method="post" >
                                                             ...
                                                             <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                ...
                                                                <label><?=lang('am_answer');?> *</label>
                                                                        <textarea class="form-control "
                                                                               name="content" 
                                                                               data-validation="required  length" 
                                                                               data-validation-length="9-1350"  ><?=$info->Content ;?> </textarea>
                                                                </div>
                                                            </div>
                                                           <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                                <div class="form-group">
                                                                <label><?=lang('am_answer_en');?> *</label>
                                                                        <textarea class="form-control "
                                                                               ...
                                                                               placeholder="<?=lang('am_content_en');?> *" ><?=$info->Content_en ;?> </textarea>
