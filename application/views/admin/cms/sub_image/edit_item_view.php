                                    ...
                                    <div class="row">
                                            <div class="col-lg-12">
											  ...
											  <?php if($CI->session->flashdata('msg')){  
                                                    ...
                                                    <div id="msgAll"></div>
                                                <form action="<?= site_url('admin/Cms/EditCmsItemSub');?>" method="post" id="target" >
                                    			
                                                            <input name="Token" value="<?=$Dep->Token;?>" type="hidden" >
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 file-upload">
                                                                 ...
                                                                 <div class="col-lg-12 file-upload-block" dir="rtl">
                                                                  ...
                                                                  <div class="col-lg-12 ">                                                         
                                                                               ...
                                                                               data-validation-length="9-250"  type="hidden" value="<?=$Dep->ImagePathSmall?>" />
                                                           ...
                                                           <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12  file-upload">
                                                                  ...
                                                                  <label class="col-lg-12" ><?=lang('am_image_cover');?></label>
                                                                  <div class="col-lg-12 file-upload-block" dir="rtl">
                                                            ...
                                                            <div class="col-lg-12">
                                                                    <button class="btn btn-primary" onclick="return checkImage();" id="saveBtn" type="submit"> <?=lang('am_save');?> </button>
                                                            </div>
                                                    </div>
                                                </form>
                                            </div>
...
<style>
#msg ,#msg p ,#msgSmalll ,#msgSmall p{
	color:red;
	}
.loading_div ,.loading_divSmall {
     text-align: center;	
    height:200px;
    width:200px;
	}
...
.loading_div .progress-co,.loading_divSmall{
    width: 200px;
    display: inline-block;
    height: 22px;
    margin-top: 0px; 
...
.loading_div .progress_word,.loading_divSmall
{
   color:#000;
}

.loading_div .progress,.loading_divSmall{
    height: 20px;
}
</style>