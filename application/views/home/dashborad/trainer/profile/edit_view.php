						...
						<div class="col-sm-9 col-md-9 col-lg-9">
							<div class="reply-form profile-edit-page">
								<div role="form" class="form-in-wrapp" id="form-in-wrapp-f1053-p976-o1" lang="en-US" dir="ltr">
									...
									<div id="note"></div>
									<div id="fields">
										<form  action="<?=site_url();?>dashborad/trainer/profile/updateInfo" method="post" class="reply-form__form">
                                                                                    ...
                                                                                    <div class="reply-form__box-04 name">
                                                                                            <input 
                                                                                                ...
                                                                                                placeholder=" <?=lang('S_Awards');?> *"
                                                                                                value="<?=$info->Scientific_Awards;?>"
                                                                                                >
                                                                                    </div>
                                                                                    <div class="reply-form__box-04 name">
                                                                                            <input 
											...
											<div class="reply-form__box-04 name">
                                                                                        ...
                                                                                        <div class="reply-form__box-04 name">
                                                                                            <input 
                                                                                                ...
                                                                                                name="Languages" 
                                                                                                data-validation="required length"
                                                                                                data-validation-length="4-200"
                                                                                                placeholder=" <?=lang('Languages');?> *"
                                                                                        ...
                                                                                        <div class="reply-form__box-04 name">
                                                                                            <textarea 
                                                                                                ...
                                                                                                data-validation="required length"
                                                                                                data-validation-length="min4"
                                                                                                placeholder=" <?=lang('P_experienc');?> *"
                                                                                                rows="10"
                                                                                            ><?=$info->Personal_experiences;?></textarea>
                                                                                        </div>
      ...
      function uploadImg(){
          ...
          var img = jQuery.each(jQuery('#file')[0].files, function(i, file) { 
                ...
                $.ajax({
                            ...
                            url: "<?= site_url('dashborad/trainer/profile/uploadImg/' . $info->Token );?>",
                            type: 'POST',
                            data: data,
                            async: true,
                            ...
                            success : function(response){
                                ...
                                if(response.status == 1 ){
                                    window.location = '<?= site_url('dashborad/trainer/profile/view/' . $info->Token );?>'
                                }
