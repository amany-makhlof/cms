							...
							<div class="row">
								<div class="col-sm-6 col-md-4 col-lg-4 text-center">
									...
									<div class="text-right">
										<a class="btn-show-all" href="<?=site_url();?>dashborad/trainer/home/coursesUser/<?=$info->Token;?>"><i class="fa fa-eye"></i> مشاهدة كل الدورات </a>
									</div>
						...
						<div class="col-sm-3 col-md-3 col-lg-3 single-team__img_profile">
							<figure class="single-team__img">
								...
								<ul class="list-unstyled list-inline">
									<li><a href="<?=site_url();?>dashborad/trainer/profile/view/<?=$info->Token;?>"><i class="fa fa-user"></i> الملف الشخصي </a></li>
									<li><a href="<?=site_url();?>dashborad/trainer/profile/edit/<?=$info->Token;?>"><i class="fa fa-edit"></i> تعديل</a></li>
								</ul>
							</figure>
						</div>
